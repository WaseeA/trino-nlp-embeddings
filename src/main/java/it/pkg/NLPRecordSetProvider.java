...
public class NLPRecordSetProvider
        implements ConnectorRecordSetProvider
{
    ...
    @Inject
    public NLPRecordSetProvider(NLPConfig config, NLPMetadata metadata)
    {
    ...
    {
        List<NLPColumnHandle> columnHandles = list.stream()
                .map(c -> (NLPColumnHandle) c)
                .collect(toList());
